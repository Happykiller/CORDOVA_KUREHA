...
(function() {
    ...
    function _init() {  
        document.addEventListener('deviceready', function(){
            $.Oda.Log.debug("Cordova loaded, device ready.");
            if(document.OdaLoaded){
                $.Oda.App.startApp();
            }else{
                document.CordovaLoaded = true;
            }
        }, false);
        $.Oda.Event.addListener({name: "oda-fully-loaded", callback : function(e){
            ...
            $.Oda.Loader.load({ depends: listDepends, functionFeedback: function(data){
                ...
                if(document.CordovaLoaded){
                    $.Oda.App.startApp();
                }else{
                    document.OdaLoaded = true;
                }
            }});
        }});
    }
    ...
    $.Oda.App = {
        ...
        startApp: function() {
            try {
                $.Oda.Log.debug("$.Oda.App.startApp started.");
